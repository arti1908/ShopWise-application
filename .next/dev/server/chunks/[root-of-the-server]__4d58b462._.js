...
const demoProducts = [
    ...
    {
        id: 101,
        name: 'Radio Bar Tirana',
        price: 900,
        imageUrl: '/bars/radio-bar.jpg',
        description: 'Trendy cocktail bar in the heart of Tirana.',
        retailer: 'Radio Bar',
        distance: 0.8,
        category: 'Bars',
        inStock: true,
    ...
    },
    {
        ...
        name: 'Nouvelle Vague',
        price: 1000,
        imageUrl: '/bars/nouvelle-vague.jpg',
        description: 'Stylish lounge bar with great music and drinks.',
        retailer: 'Nouvelle Vague',
        distance: 1.2,
        category: 'Bars',
        inStock: true,
        location: 'Tirana'
    },
    {
        ...
        name: 'Hemingway Bar',
        price: 850,
        imageUrl: '/bars/hemingway.jpg',
        description: 'Cozy bar inspired by classic cocktails and literature.',
        retailer: 'Hemingway Bar',
        distance: 1.6,
        category: 'Bars',
        inStock: true,
        location: 'Tirana'
